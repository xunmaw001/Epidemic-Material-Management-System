...
public class JuanzengView extends JuanzengEntity implements Serializable {
	...
	*/
	...
	private String juanzengYesnoValue;
	...
	* 获取： 报名状态的值
	*/
	public String getJuanzengYesnoValue() {
		return juanzengYesnoValue;
	}
	/**
	* 设置： 报名状态的值
	*/
	public void setJuanzengYesnoValue(String juanzengYesnoValue) {
		this.juanzengYesnoValue = juanzengYesnoValue;
	}
	...
	public String toString() {
		return "JuanzengView{" +
			", juanzengYesnoValue=" + juanzengYesnoValue +
			", wuziName=" + wuziName +
