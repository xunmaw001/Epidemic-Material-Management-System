...
public class ShenqingView extends ShenqingEntity implements Serializable {
	...
	*/
	...
	private String shenqingYesnoValue;
	...
	* 获取： 报名状态的值
	*/
	public String getShenqingYesnoValue() {
		return shenqingYesnoValue;
	}
	/**
	* 设置： 报名状态的值
	*/
	public void setShenqingYesnoValue(String shenqingYesnoValue) {
		this.shenqingYesnoValue = shenqingYesnoValue;
	}
	...
	public String toString() {
		return "ShenqingView{" +
			", shenqingYesnoValue=" + shenqingYesnoValue +
			", wuziName=" + wuziName +
