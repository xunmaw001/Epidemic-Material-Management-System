...
public class ShenqingEntity<T> implements Serializable {
	...
	@DateTimeFormat
    @ColumnInfo(comment="物资申请时间",type="timestamp")
     ...
     * 物资申请数量
     */
    @ColumnInfo(comment="物资申请数量",type="int(11)")
    ...
    public String toString() {
        return "Shenqing{" +
            ", id=" + id +
            ", shenqingUuidNumber=" + shenqingUuidNumber +
            ", wuziId=" + wuziId +
            ", yonghuId=" + yonghuId +
            ", shenqingText=" + shenqingText +
            ", insertTime=" + DateUtil.convertString(insertTime,"yyyy-MM-dd") +
            ", shenqingShuliang=" + shenqingShuliang +
            ", shenqingYesnoTypes=" + shenqingYesnoTypes +
            ", shenqingYesnoText=" + shenqingYesnoText +
            ", shenqingShenheTime=" + DateUtil.convertString(shenqingShenheTime,"yyyy-MM-dd") +
