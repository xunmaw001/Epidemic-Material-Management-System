    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="shenqingUuidNumber">
                       <el-input v-model="ruleForm.shenqingUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.shenqingUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="shenqingUuidNumber">
                           <el-input v-model="ruleForm.shenqingUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="理由" prop="shenqingText">
                        <el-input type="textarea"  :readonly="ro.shenqingText" v-model="ruleForm.shenqingText" placeholder="理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shenqingText" label="理由" prop="shenqingText">
                            <span v-html="ruleForm.shenqingText"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物资申请数量" prop="shenqingShuliang">
                       <el-input v-model="ruleForm.shenqingShuliang"
                                 placeholder="物资申请数量" clearable  :readonly="ro.shenqingShuliang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物资申请数量" prop="shenqingShuliang">
                           <el-input v-model="ruleForm.shenqingShuliang"
                                     placeholder="物资申请数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shenqingYesnoTypes" label="报名状态" prop="shenqingYesnoTypes">
                        <el-input v-model="ruleForm.shenqingYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shenqingYesnoText" label="审核回复" prop="shenqingYesnoText">
                        <span v-html="ruleForm.shenqingYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shenqingShenheTime" label="审核时间" prop="shenqingShenheTime">
                        <span v-html="ruleForm.shenqingShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    shenqingUuidNumber: true,
                    wuziId: false,
                    yonghuId: false,
                    shenqingText: false,
                    insertTime: false,
                    shenqingShuliang: false,
                    shenqingYesnoTypes: false,
                    shenqingYesnoText: false,
                    shenqingShenheTime: false,
                },
                ruleForm: {
                    shenqingUuidNumber: new Date().getTime(),
                    wuziId: '',
                    yonghuId: '',
                    shenqingText: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '物资申请时间不能为空', trigger: 'blur' },
                          ],
                   shenqingShuliang: [
                              { required: true, message: '物资申请数量不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shenqingYesnoTypesOptions = data.data.list;
                    }
                });
                            ...
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shenqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
