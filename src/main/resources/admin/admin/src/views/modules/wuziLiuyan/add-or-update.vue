    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="wuziLiuyanText">
                        <el-input type="textarea"  :readonly="ro.wuziLiuyanText" v-model="ruleForm.wuziLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziLiuyanText" label="留言内容" prop="wuziLiuyanText">
                            <span v-html="ruleForm.wuziLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.wuziId = true;//物资
                this.ro.yonghuId = true;//用户
                this.ro.wuziLiuyanText = true;//留言内容
            }else{
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`wuziLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.wuziLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
