    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="juanzengUuidNumber">
                       <el-input v-model="ruleForm.juanzengUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.juanzengUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="juanzengUuidNumber">
                           <el-input v-model="ruleForm.juanzengUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="理由" prop="juanzengText">
                        <el-input type="textarea"  :readonly="ro.juanzengText" v-model="ruleForm.juanzengText" placeholder="理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.juanzengText" label="理由" prop="juanzengText">
                            <span v-html="ruleForm.juanzengText"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物资捐赠数量" prop="juanzengShuliang">
                       <el-input v-model="ruleForm.juanzengShuliang"
                                 placeholder="物资捐赠数量" clearable  :readonly="ro.juanzengShuliang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物资捐赠数量" prop="juanzengShuliang">
                           <el-input v-model="ruleForm.juanzengShuliang"
                                     placeholder="物资捐赠数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.juanzengYesnoTypes" label="报名状态" prop="juanzengYesnoTypes">
                        <el-input v-model="ruleForm.juanzengYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.juanzengYesnoText" label="审核回复" prop="juanzengYesnoText">
                        <span v-html="ruleForm.juanzengYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.juanzengShenheTime" label="审核时间" prop="juanzengShenheTime">
                        <span v-html="ruleForm.juanzengShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    juanzengUuidNumber: true,
                    wuziId: false,
                    yonghuId: false,
                    juanzengText: false,
                    insertTime: false,
                    juanzengShuliang: false,
                    juanzengYesnoTypes: false,
                    juanzengYesnoText: false,
                    juanzengShenheTime: false,
                },
                ruleForm: {
                    juanzengUuidNumber: new Date().getTime(),
                    wuziId: '',
                    yonghuId: '',
                    juanzengText: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '物资捐赠时间不能为空', trigger: 'blur' },
                          ],
                   juanzengShuliang: [
                              { required: true, message: '物资捐赠数量不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=juanzeng_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.juanzengYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`juanzeng/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.juanzengCrossAddOrUpdateFlag = false;
                                        this.parent.search();
